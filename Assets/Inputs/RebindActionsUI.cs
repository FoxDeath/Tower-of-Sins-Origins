    ...
    public class RebindActionsUI : MonoBehaviour
    {
        ...
        protected void OnEnable()
        {
            if (s_RebindActionUIs == null)
                s_RebindActionUIs = new List<RebindActionsUI>();
        ...
        private static List<RebindActionsUI> s_RebindActionUIs;
        ...
        [Serializable]
        public class UpdateBindingUIEvent : UnityEvent<RebindActionsUI, string, string, string>
        {
        }

        [Serializable]
        public class InteractiveRebindEvent : UnityEvent<RebindActionsUI, InputActionRebindingExtensions.RebindingOperation>
        {
        }
    }
}
